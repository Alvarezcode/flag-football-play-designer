...
export const formationTemplates: FormationTemplate[] = [
  {
    ...
    positions: { l1: { x: 45, y: 20 }, l2: { x: 43, y: 34 }, r2: { x: 43, y: 66 }, r1: { x: 45, y: 80 }, center: { x: 48, y: 50 }, quarterback: { x: 39, y: 50 }, back: { x: 32, y: 62 } },
  },
  {
    id: "trips-right",
    name: "Trips Right",
    ...
    positions: { l1: { x: 44, y: 22 }, l2: { x: 43, y: 63 }, r2: { x: 43, y: 72 }, r1: { x: 43, y: 81 }, center: { x: 48, y: 50 }, quarterback: { x: 39, y: 50 }, back: { x: 32, y: 62 } },
  },
  {
    id: "bunch-left",
    name: "Bunch Left",
    ...
    positions: { l1: { x: 43, y: 19 }, l2: { x: 43, y: 28 }, r2: { x: 43, y: 37 }, r1: { x: 44, y: 80 }, center: { x: 48, y: 50 }, quarterback: { x: 39, y: 50 }, back: { x: 33, y: 41 } },
  },
  {
    id: "zone-2-3",
    name: "2–3 Zone",
